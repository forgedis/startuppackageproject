...
-- Clear existing categories (uncomment if needed)
-- DELETE FROM categories;

-- Insert all categories
INSERT INTO categories (slug, name_cs, name_en, description_cs, icon, sort_order, is_active) VALUES
('finance-a-ucetnictvi', 'Finance & účetnictví', 'Finance & Accounting', 'Účetnictví, reporting, cashflow, financování, FX, rozjezd účetních procesů', 'DollarSign', 1, true),
